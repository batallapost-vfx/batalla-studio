...
export default function ContactSection() {
  return (
    <section id="contact" className="scroll-mt-24">
      {/* Hero */}
      <div className="pt-16 sm:pt-20 pb-14 px-8 text-center">
        ...
        <p className="text-cream/60 text-base md:text-lg font-light max-w-xl mx-auto">
          We would love to hear from you on any possible subject. VFX? Sure.
        </p>
      </div>
      ...
      <div className="max-w-md lg:max-w-3xl mx-auto px-8 pb-32 grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-10">
        <div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <a
                href="mailto:francisco@batallapost.com"
                className="text-cream/55 text-sm hover:text-gold transition-colors duration-300 font-light"
              >
                francisco@batallapost.com
              </a>
            </div>
          </div>
        </div>
        ...
        <div>
          <p className="text-gold text-[0.6rem] uppercase tracking-[0.45em] mb-3">Jobs</p>
          <p className="text-cream/70 text-sm font-light mb-1">Enviá tu reel a</p>
          <a
            href="mailto:jobs@batallapost.com"
            className="text-cream/55 text-sm hover:text-gold transition-colors duration-300 font-light"
          >
            jobs@batallapost.com
          </a>
        </div>
      </div>
    </section>
